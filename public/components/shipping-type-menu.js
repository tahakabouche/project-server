class ShippingTypeMenu extends HTMLElement {
    constructor() {
      super();
      this.innerHTML = `
            <div class="status-dropdown-container">
                  ...
                  <div class="dropdown-options">
                        <div class="dropdown-option" data-value="Stopdesk">Stopdesk</div>
                        <div class="dropdown-option" data-value="Home">Home</div>       
                  </div>
                </div>
         `;
    }
  ...
  customElements.define("shipping-type-menu", ShippingTypeMenu);
